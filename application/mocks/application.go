...
import (
	...
	application "github.com/nironwp/hexagonal-architecture/application"
)
...
func (m *MockProductInterface) Disable() {
	m.ctrl.T.Helper()
...
func (m *MockProductInterface) GetQuantity() int {
	m.ctrl.T.Helper()
...
func (m *MockProductInterface) IsValid() error {
	m.ctrl.T.Helper()
...
func (m *MockProductServiceInterface) Create(name string, price float64, quantity int) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", name, price, quantity)
...
func (mr *MockProductServiceInterfaceMockRecorder) Create(name, price, quantity interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockProductServiceInterface)(nil).Create), name, price, quantity)
}
